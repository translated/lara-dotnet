...
def update_version(part: str) -> str:
    ...
    csproj_file = os.path.join(os.path.dirname(__file__), "src", "Lara.Sdk", "Lara.Sdk.csproj")
    sdk_version_file = os.path.join(os.path.dirname(__file__), "src", "Lara.Sdk", "SdkVersion.cs")
